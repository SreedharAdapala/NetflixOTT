...
extension UIViewController {
    ...
    /*
    func showErrorAlert() {
        self.presentAlertWithTitle(title: Generic.sharedInstance.getLabelDisplayData(fieldName: "Error") , message: "".localized(), options: Generic.sharedInstance.getLabelDisplayData(fieldName: "Ok") ) { (String) in
        }
    }
    func showErrorAlert(message : String ) {
        self.presentAlertWithTitle(title: Generic.sharedInstance.getLabelDisplayData(fieldName: "Error") , message: Generic.sharedInstance.getLabelDisplayData(fieldName: message), options: Generic.sharedInstance.getLabelDisplayData(fieldName: "Ok") ) { (String) in
        }
    }
    */
    //
